...
import 'package:careertrack/auth/LoginPage.dart';
    ...
    return IntroductionScreen(
      ...
      pages: [
        ...
        PageViewModel(
          ...
          body:
          "Get answers to your career related queries in no time.",
        ...
        PageViewModel(
          ...
          body:
          "We will ensure you choose best career option.",
...
//        ),
      ...
      done: const Text('Login Now', style: TextStyle(fontWeight: FontWeight.w900, color: Colors.blue)),
