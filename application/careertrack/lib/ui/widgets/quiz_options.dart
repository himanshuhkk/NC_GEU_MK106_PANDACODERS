...
import 'package:careertrack/resources/api_provider.dart';
import 'package:careertrack/ui/pages/error.dart';
import 'package:careertrack/ui/pages/quiz_page.dart';
              ...
              child: Wrap(
                ...
                children: <Widget>[
                  ...
                  ActionChip(
                    ...
                    backgroundColor: _noOfQuestions == 10 ? Colors.deepOrange : Colors.grey.shade600,
                    onPressed: () => _selectNumberOfQuestions(10),
                  ),
                  ActionChip(
                    label: Text("20"),
                    labelStyle: TextStyle(color: Colors.white),
                    backgroundColor: _noOfQuestions == 20 ? Colors.deepOrange : Colors.grey.shade600,
                    onPressed: () => _selectNumberOfQuestions(20),
                  ),
                  ActionChip(
                    label: Text("30"),
                    labelStyle: TextStyle(color: Colors.white),
                    backgroundColor: _noOfQuestions == 30 ? Colors.deepOrange : Colors.grey.shade600,
                  ...
                  ActionChip(
                    label: Text("50"),
                    labelStyle: TextStyle(color: Colors.white),
                    backgroundColor: _noOfQuestions == 50 ? Colors.deepOrange : Colors.grey.shade600,
              ...
              child: Wrap(
                ...
                children: <Widget>[
                  ...
                  ActionChip(
                    label: Text("Any"),
                    labelStyle: TextStyle(color: Colors.white),
                    backgroundColor: _difficulty == null ? Colors.deepOrange : Colors.grey.shade600,
                    onPressed: () => _selectDifficulty(null),
                  ),
                  ActionChip(
                    label: Text("Easy"),
                    labelStyle: TextStyle(color: Colors.white),
                    backgroundColor: _difficulty == "easy" ? Colors.orange : Colors.grey.shade600,
                  ...
                  ActionChip(
                    label: Text("Hard"),
                    labelStyle: TextStyle(color: Colors.white),
                    backgroundColor: _difficulty == "hard" ? Colors.deepOrange : Colors.grey.shade600,
